...
@ContextConfiguration(locations = { "classpath:applicationContext_spring.xml",
		"classpath:applicationContext_springMvc.xml" })
public class MvcTest {
	...
	public void testPage() throws Exception {
		//模拟请求拿到返回值
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/getAllEmp").param("pageNumber", "5"))
				.andReturn();
